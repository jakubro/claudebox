...
export default function NewSessionBridge({ refs }) {
  ...
  // cancelCreation is wired inside executeNewSession itself - the closure captures the calling instance's refs,
  // so cancel keeps working correctly even when Dockview remounts the calling component (e.g., HeaderActions).

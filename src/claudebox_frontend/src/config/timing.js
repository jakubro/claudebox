...
export const SESSION_STORAGE_SWEEP_INTERVAL_MS = 300_000
export const FLOATING_PANEL_DISMISS_MS = 150
export const FLOATING_PANEL_HOVER_INTENT_MS = 350
export const INLINE_REPLY_HOVER_OPEN_MS = 150
export const INLINE_REPLY_HOVER_CLOSE_MS = 150
...
export const MERMAID_FAILURE_NOTICE_DELAY_MS = 750
export const SCROLL_SETTLE_MAX_FRAMES = 30
export const RATE_LIMIT_SWEEP_INTERVAL_MS = 30_000

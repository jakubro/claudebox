"""Installation metadata and the help epilog that renders it.

Must not be named ``cli``: that would shadow the ``cli`` runner the package root re-exports from ``core.cli``.
"""
